...
urlpatterns =  format_suffix_patterns([
    ...
    url(r'^api/absence/approve/',       ApproveAbsenceRequest.as_view(), name="api-approve-absence"),
    url(r'^api/absence/reject/',        RejectAbsenceRequest.as_view(), name="api-reject-absence"),
